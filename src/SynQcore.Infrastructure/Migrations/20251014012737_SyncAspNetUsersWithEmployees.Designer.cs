...
namespace SynQcore.Infrastructure.Migrations
{
    ...
    [Migration("20251014012737_SyncAspNetUsersWithEmployees")]
    partial class SyncAspNetUsersWithEmployees
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SynQcore.Domain.Entities.ModerationAppealEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("AppealByEmployeeId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SynQcore.Domain.Entities.ModerationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<short?>("AutoDetectionScore")
                    ...
                    b.Property<bool>("IsAutomaticDetection")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("SynQcore.Domain.Entities.ModerationLogEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsAutomaticAction")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.HasIndex("ModerationId", "CreatedAt")
            ...
            modelBuilder.Entity("SynQcore.Domain.Entities.UserPunishmentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ModeratorIpAddress")
                        .HasMaxLength(45)
                        .HasColumnType("character varying(45)");
                    ...
                    b.Property<int>("PreviousWarnings")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("SynQcore.Domain.Entities.ModerationAppealEntity", b =>
                {
                    b.HasOne("SynQcore.Domain.Entities.Organization.Employee", "AppealByEmployee")
                        .WithMany()
                        .HasForeignKey("AppealByEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SynQcore.Domain.Entities.ModerationEntity", "Moderation")
                        .WithMany("Appeals")
                        .HasForeignKey("ModerationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SynQcore.Domain.Entities.Organization.Employee", "ReviewedByEmployee")
                        .WithMany()
                        .HasForeignKey("ReviewedByEmployeeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("AppealByEmployee");
            ...
            modelBuilder.Entity("SynQcore.Domain.Entities.ModerationEntity", b =>
                {
                    b.HasOne("SynQcore.Domain.Entities.Organization.Employee", "ContentAuthor")
                        .WithMany()
                        .HasForeignKey("ContentAuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SynQcore.Domain.Entities.Organization.Employee", "Moderator")
                        .WithMany()
                        .HasForeignKey("ModeratorId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SynQcore.Domain.Entities.Organization.Employee", "ReportedByEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("SynQcore.Domain.Entities.ModerationLogEntity", b =>
                {
                    b.HasOne("SynQcore.Domain.Entities.Organization.Employee", "ActionByEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("SynQcore.Domain.Entities.UserPunishmentEntity", b =>
                {
                    b.HasOne("SynQcore.Domain.Entities.Organization.Employee", "AppliedByEmployee")
                        .WithMany()
