...
public static class SynQcoreInfo
{
    ...
    {
        public const int EntitiesCount = 25;
        public const int DatabaseTables = 25;
        public const int ProjectsCount = 9;
        public const string CurrentPhase = "Phase 4.3 - Corporate Media & Document Management";
        public const string NextPhase = "Phase 5.1 - Blazor Advanced Interface";
        public const string CompletionPercentage = "75%";
        public const string ApiEndpoints = "150+";
    }
